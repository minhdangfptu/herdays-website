...
function LoginForm() {
  ...
  return (
    <section className="login-form-panel" aria-labelledby="login-title">
      <div style={{ paddingTop: "40px" }} className="login-form-panel__content">
        ...
        >
          <label className="form-field">
            <span style={{fontWeight: "400"}}>Email/Số điện thoại</span>
          ...
          <div className="form-options">
            <label className="remember-me">
              <input className="remember-me__checkbox" type="checkbox" name="remember" />
...
function LoginPage() {
  return (
    <main className="login-page relative isolate grid min-h-svh place-items-center overflow-x-hidden overflow-y-auto bg-[#f9eef2] p-4">
      <div className="login-card grid w-full max-w-[1100px] overflow-hidden rounded-xl bg-white min-[961px]:h-[90vh]">
        <LoginForm />
        <WelcomePanel />
      </div>
    </main>
