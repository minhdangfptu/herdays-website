                      ...
                      <div className="mt-3 flex items-end justify-between gap-3">
                        ...
                        <label className="text-xs font-bold text-slate-500">
                          ...
                          <select
                            ...
                            disabled={!item.selected}
                            onChange={(event) => handleBoxProductMode(
                              product.id,
                              event.target.value === 'customizable'
                            )}
                            aria-label={`Loại sản phẩm ${product.productName}`}
                            className="mt-1 block h-9 rounded-md border border-slate-200 bg-white px-2 text-xs font-bold text-slate-700 outline-none focus:border-pink-300 disabled:bg-slate-100 disabled:text-slate-400"
                          >
