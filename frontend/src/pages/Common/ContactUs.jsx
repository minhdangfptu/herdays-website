...
import { Phone, Mail, MapPin, AtSign, ChevronDown } from "lucide-react";
    ...
    <main className="contact-us bg-gray-50 py-5 px-4 font-roboto">
      <div className="max-w-[1100px] mx-auto">
        <div className="grid md:grid-cols-2 gap-10 ">
          ...
          <div style={{ paddingTop: "40px" }} className="flex flex-col">
            {/* Badge */}
              ...
              {contactCards.map((card, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-3">
                    {/* Icon Circle */}
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-pink-500 flex-shrink-0">
                      <IconComponent
                        size={18}
                    ...
                    <div>
                      ...
                      {/* Card Description */}
                      <p className="text-gray-700 font-semibold text-sm break-words">
                        {card.description}
                      </p>
                    </div>
                  </div>
            ...
            {/* Map Image */}
            <div className="rounded-2xl overflow-hidden h-40 md:h-67">
              <img
                src={mapContact}
                alt="Contact Map"
          ...
          <div className="flex flex-col justify-start">
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-pink-500 text-white py-2.5 rounded-lg font-semibold text-sm hover:bg-pink-600 transition-colors duration-200"
                >
                  Gửi
                </button>
              </form>
