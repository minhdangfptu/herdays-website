...
export default function DueDateCalculatorByUltrasound({
  ...
  const handleCalculate = (e) => {
    ...
    const dueDate = new Date(
      uDate.getTime() + remainingDays * 24 * 60 * 60 * 1000,
    );
  ...
  return (
    <div className="calculator-widget">
      ...
      <p className="calc-desc">
        Cập nhật lại ngày dự sinh chuẩn xác nhất dựa trên các chỉ số sinh trắc
        học trên phiếu siêu âm.
      </p>
      ...
      <div className="calc-note">
        ...
        <p>
          <strong>Lưu ý:</strong> Ngày dự sinh theo siêu âm 3 tháng đầu (đặc
          biệt là tuần 11-13) thường được bác sĩ coi là độ chính xác cao nhất để
          chốt mốc sinh đẻ.
        </p>
      </div>
