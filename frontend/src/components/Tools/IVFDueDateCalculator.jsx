  ...
  return (
    <div className="calculator-widget">
      ...
      <p className="calc-desc">
        Công cụ được thiết kế chuyên biệt dành cho các mẹ bầu thụ tinh ống
        nghiệm.
      </p>
      ...
      <div className="calc-note">
        ...
        <p>
          <strong>Lưu ý:</strong> Cách tính qua IVF thường mang lại độ chuẩn xác
          rất cao về tuổi thai so với tính theo kỳ kinh nguyệt tự nhiên, giúp
          các bác sĩ theo dõi sát sao sự phát triển của thai nhi.
        </p>
      </div>
