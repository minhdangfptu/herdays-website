  ...
  return (
    <div className="calculator-widget">
      ...
      <p className="calc-desc">
        Chỉ cần ngày rớt dâu cuối cùng, HerDays sẽ tính ngay cột mốc bé yêu chào
        đời.
      </p>
      ...
      <div className="calc-note">
        ...
        <p>
          <strong>Lưu ý:</strong> Ngày dự sinh chỉ là thời điểm dự kiến bé tròn
          40 tuần thai. Thực tế, chỉ có khoảng 5% em bé chào đời đúng chóc vào
          ngày này, phần lớn sẽ sinh dao động trong khoảng từ tuần 37 đến tuần
          41.
        </p>
      </div>
